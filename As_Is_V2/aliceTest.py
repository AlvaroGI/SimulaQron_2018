...
#-------print("Alice knows eve is ready")------------------------------------------------------%
    ...
    # Send Pub_key_index to Bob
        ...
        print("\n Alice decides to keep measurements number", Pub_Key)
    ...
    # Create new bistring for Alice with chosen index
        ...
        print(" The measurements Alice can use for extraction are", Alice_Bitstring)
    ...
    # Determine error rate
        ...
        print(" Alice checks the measurements number", Check_Bitstring_Index, ", which are", Check_Bitstring_Alice)
        ErrorAmount=0
        ...
        if ErrorRate > ErrorThreshold:
           print("(!) Errorrate too high, Alice aborts protocol")
