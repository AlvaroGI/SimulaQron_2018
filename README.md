...
After each run, a new .txt file will be generated inside the 'logs_keys' folder (do NOT erase this folder). You can identify the one-bit key you have generated by the name of the file (labeled with the date and time the key was produced, for example '2019-01-19_17/24/18.930871.txt'). If you want to produce a longer key, you can run the protocol several times or use a different extractor that leads to a larger amount of final key bits.
